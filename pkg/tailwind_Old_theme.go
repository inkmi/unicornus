...
type TailwindOldTheme struct {
}

func (t TailwindOldTheme) themeRenderInput(rctx *RenderContext, e FormElement, field DataField, prefix string) {
	rctx.out.WriteString("<div class=\"mt-6\">")
	if rctx.OnlyDisplay(field.Name) {
		if len(e.Config.Label) > 0 {
			rctx.out.WriteString(fmt.Sprintf("<div class=\"block text-sm font-medium text-gray-500\">%s</div>", e.Config.Label))
		}
		rctx.out.WriteString(fmt.Sprintf("<div class=\"text-sm font-medium text-gray-900\">%s</div>", field.ViewVal()))
	} else {
		if len(e.Config.Label) > 0 {
...
func (t TailwindOldTheme) themeRenderSelect(rctx *RenderContext, e FormElement, field DataField, description string, prefix string) {
	rctx.out.WriteString("<div class=\"mt-6\">")
	if rctx.OnlyDisplay(field.Name) {
		if len(e.Config.Label) > 0 {
...
func (t TailwindOldTheme) themeRenderYesNo(rctx *RenderContext, e FormElement, field DataField, description string, prefix string) {
...
func (t TailwindOldTheme) themeRenderCheckbox(rctx *RenderContext, e FormElement, field DataField, description string, prefix string) {
...
func (t TailwindOldTheme) themeRenderMulti(rctx *RenderContext, f DataField, e FormElement, prefix string) {
	rctx.out.WriteString("<div class=\"mt-6\">")
...
func (t TailwindOldTheme) renderMultiGroup(rctx *RenderContext, f DataField, group string, groupName string) {
	rctx.out.WriteString("<div class=\"mt-6\">")
	if len(groupName) > 0 {
...
func (t TailwindOldTheme) themeRenderHeader(rctx *RenderContext, e FormElement) {
	rctx.out.WriteString(fmt.Sprintf("<h2>%s</h2>", e.Name))
}

func (t TailwindOldTheme) themeRenderGroup(rctx *RenderContext, m map[string]DataField, prefix string, e FormElement) {
